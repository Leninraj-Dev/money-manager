...
export class Backend implements backendInterface {
    ...
    async addTransaction(arg0: bigint, arg1: string, arg2: string, arg3: string, arg4: Time): Promise<number> {
        if (this.processError) {
            try {
    ...
    async deleteTransaction(arg0: number): Promise<void> {
        if (this.processError) {
            try {
    ...
    async editTransaction(arg0: number, arg1: bigint, arg2: string, arg3: string, arg4: string, arg5: Time): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getTransaction(arg0: number): Promise<Transaction> {
        if (this.processError) {
            try {
